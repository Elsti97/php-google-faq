...
$arrayFAQ = [
  ...
  [
    "domande" => "<h5 class='my-4'>Stabilire il paese associato al tuo account</h5>",
    "risposte" => [
...
<body>
  ...
  <main>
    ...
    <div class="w-50 m-auto">
      <?php
      foreach ($arrayFAQ as $array => $value) {
        echo "<h3 class='my-5'>{$value["domande"]}</h3>";
        foreach ($value["risposte"] as $arrayRisposte => $val) {
          echo "<p>$val</p>";
        }
      }
      ?>
